...
int main(int argc, char* argv[]) {
    ...
    if (!val) {
        val = R"({{"path":"{}","role":"25","discordId":"57228","secret_extra":"frAQBc8W","dataId":"44262:mokPVuACUwR5Qw==","hwid":"---------Hi-Korepi-Devs---------:785c4495d9aae9d4ab61b9755f566029"}})";
        ini.SetValue("inject", "secrets", val);
    }
    ini.SaveFile("cfg.ini");

    std::string inject_secrets = std::string(val).c_str();
    std::string filename = (argc == 2 ? argv[1] : "korepi47.dll");
